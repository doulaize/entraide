                        ...
                        <tr>
                            <td colspan="6">
                                <div>
                                    ...
                                    document.getElementById('backup').style.display='none';>Donn&eacute;es personnelles</a>&nbsp;&nbsp;
                                    <a href="#" onclick="writediv('');
                                    ...
                                    document.getElementById('params').style.display='none';"
                                    document.getElementById('backup').style.visibility='hidden';
                                    document.getElementById('backup').style.display='none';>Section Domiciliations</a>&nbsp;&nbsp;
                                    <a href="#" onclick="writediv('');
                                    ...
                                    document.getElementById('params').style.display='none';"
                                    document.getElementById('backup').style.visibility='hidden';
                                    document.getElementById('backup').style.display='none';>Utilisateurs</a>&nbsp;&nbsp;
                                    ...
                                    document.getElementById('params').style.display='none';"
                                    document.getElementById('backup').style.visibility='hidden';
                                    document.getElementById('backup').style.display='none';>Statistiques</a>&nbsp;&nbsp;
                                    <a href="#" onclick="writediv('');
                                    ...
                                    document.getElementById('stats').style.display='none';"
                                    document.getElementById('backup').style.visibility='hidden';
                                    document.getElementById('backup').style.display='none';>Param&egrave;tres</a>&nbsp;&nbsp;
                                    <a href="#" onclick="writediv('');
                                    ...
                                    document.getElementById('stats').style.display='none';"
                                    document.getElementById('params').style.visibility='hidden';
                                    document.getElementById('params').style.display='none';>Sauvegarde</a>&nbsp;&nbsp;
                                    <?}?>
                                ...
                                <div id="params" style="visibility:hidden;display:none;">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>||</td>
                                            <td>
                                                <a href="#" onclick="document.getElementById('alert').innerHTML = '';writediv(file('./contenu/gestion_statut.php'));">gestion des statuts</a>
                                            </td>
                                            <td>||</td>
                                            <td>
                            ...
                            <div style="visibility:hidden;display:none;" id="params">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>||</td>
                                        <td>
                                            <a href="#" onclick="document.getElementById('alert').innerHTML = '';window.open('./contenu/gestion_sorties.php');">gestion des sorties</a>
                                        </td>
                                    </tr>
                                </table>
                                <?}?>
