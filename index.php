...
<table>
	<tr>
		<td colspan="6">
<div>
	<a href="#" onclick="writediv('');document.getElementById('sous_menu_data_perso').style.visibility='visible';document.getElementById('sous_menu_data_perso').style.display='block';document.getElementById('section_dom').style.visibility='hidden';document.getElementById('section_dom').style.display='none';document.getElementById('debut').style.visibility='hidden';document.getElementById('debut').style.display='none';document.getElementById('users').style.visibility='hidden';document.getElementById('users').style.display='none';document.getElementById('stats').style.visibility='hidden';document.getElementById('stats').style.display='none';document.getElementById('params').style.visibility='hidden';document.getElementById('params').style.display='none';">DonnŽes personnelles</a>&nbsp;&nbsp;
